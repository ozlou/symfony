 ...
 */
final class Version20220429084612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce ADD title VARCHAR(255) NOT NULL, ADD description VARCHAR(255) NOT NULL, ADD price VARCHAR(255) NOT NULL, ADD created_at DATETIME NOT NULL, ADD city VARCHAR(255) NOT NULL, CHANGE user_id id_vehicule_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE publier ADD id_annonce_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce DROP title, DROP description, DROP price, DROP created_at, DROP city, CHANGE id_vehicule_id user_id INT DEFAULT NULL');
